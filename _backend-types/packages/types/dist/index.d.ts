...
export type Role = "SUPER_ADMIN" | "ADMIN" | "INSTRUCTOR" | "MENTOR" | "SUPPORT_AGENT" | "STUDENT";
export type DeviceType = "PC" | "MOBILE";
export type RegistrationType = "BD" | "FOREIGN";
...
export type StudentLessonContent = QuizLessonContent | TextLessonContent | VideoLessonContent;
...
export type PaymentGateway = "stripe" | "sslcommerz" | "paypal" | "bkash" | "nagad";
export type ManualPaymentProvider = "bkash" | "nagad";
export type PaymentStatus = "PENDING" | "AWAITING_VERIFICATION" | "COMPLETED" | "FAILED" | "REJECTED" | "EXPIRED" | "REFUNDED";
...
export type InstallmentPaymentStatus = "PENDING" | "AWAITING_VERIFICATION" | "PAID" | "OVERDUE" | "CANCELLED";
...
export type DigitalProductType = "PDF" | "EBOOK" | "TRADING_JOURNAL" | "TEMPLATE" | "INDICATOR" | "TOOL" | "BUNDLE";
...
export type SessionType = "COURSE_CLASS" | "PUBLIC_WEBINAR" | "QA_SESSION" | "GROUP_MENTORSHIP";
...
export interface AICoachWaitlistEntry {
    id: string;
    email: string;
    userId: string | null;
    studentId: string | null;
...
export interface AICoachWaitlistStats {
    total: number;
    registered: number;
    guest: number;
    today: number;
...
export interface AICoachWaitlistInviteResult {
    sent: number;
    skipped: number;
    failed: number;
    total: number;
}
export interface AICoachWaitlistListResult {
    items: AICoachWaitlistEntry[];
    total: number;
    page: number;
    pageSize: number;
    stats: AICoachWaitlistStats;
}
export interface AICoachWaitlistJoinResult {
    id: string;
    email: string;
    alreadyRegistered: boolean;
}
export interface AICoachWaitlistCountResult {
    count: number;
}
export type AICoachMessageRole = "user" | "assistant" | "system";
export interface AICoachMessageItem {
    id: string;
    role: AICoachMessageRole;
    content: string;
    createdAt: string;
}
export interface AICoachSessionItem {
    id: string;
    title: string;
    messageCount: number;
...
export interface AICoachSessionDetail {
    id: string;
    title: string;
    messages: AICoachMessageItem[];
    createdAt: string;
    updatedAt: string;
}
export interface AICoachAccessInfo {
    enabled: boolean;
    tier: "free" | "enrolled" | "premium" | "admin";
    dailyLimit: number;
    usedToday: number;
    remainingToday: number;
    canSend: boolean;
}
export interface AICoachSendMessageResult {
    userMessage: AICoachMessageItem;
    assistantMessage: AICoachMessageItem;
    sessionTitle: string;
    access: AICoachAccessInfo;
}
export interface AICoachInsightItem {
    type: "continue_learning" | "completed" | "psychology" | "getting_started";
    title: string;
    description: string;
    courseSlug: string | null;
}
export interface AICoachAdminUsageStats {
    totalSessions: number;
...
export type InquirySubject = "GENERAL" | "COURSE" | "PAYMENT" | "CONSULTATION" | "TECHNICAL" | "PARTNERSHIP";
...
export { quizQuestionTypeSchema, quizQuestionSchema, quizContentSchema, parseQuizContent, } from "./schemas/quiz";
export type { QuizQuestionType, QuizQuestionStored, QuizContentStored, QuizQuestionItem, QuizLessonContent, QuizQuestionResultItem, QuizSubmitResult, } from "./schemas/quiz";
export type { ConsultationTypeId, ConsultationType, ConsultationTypeConfig, } from "./consultation";
export { CONSULTATION_TYPES, CONSULTATION_TYPE_LABELS, MENTOR_TRADING_SKILLS, MENTOR_CONSULTATION_SPECIALIZATIONS, isConsultationTypeId, isConsultationType, consultationTypeIdToEnum, consultationTypeToId, getConsultationConfigById, getConsultationConfigByType, getConsultationLabel, resolveConsultationTypeId, } from "./consultation";
